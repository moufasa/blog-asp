namespace Blog.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Blog.Models.BlogContext>
    {
        ...
        protected override void Seed(Blog.Models.BlogContext context)
        {
            ...
            var pa = context.Pages;
            foreach (var p in pa) {
                context.Pages.Remove(p);
            }

            var po = context.Posts;
            foreach (var p in po)
            {
...
Cum horribilem walking dead resurgere de crazed sepulcris creaturis, zombie sicut de grave feeding iride et serpens. Pestilentia, shaun ofthe dead scythe animated corpses ipsa screams. Pestilentia est plague haec decaying ambulabat mortuos. Sicut zeder apathetic malus voodoo. Aenean a dolor plan et terror soulless vulnerum contagium accedunt, mortui iam vivam unlife. Qui tardius moveri, brid eof reanimator sed in magna copia sint terribiles undeath legionis. Alii missing oculis aliorum sicut serpere crabs nostram. Putridi braindead odores kill and infect, aere implent left four dead.", Slug="slug-de-malade", Online= true },
                ...
                new Post { Title = "2012 ou le fail des mayas ?", Categorie = categories.Single(g => g.Name == "Insolite"), Date = DateTime.Parse("2012-10-06"),  Author = "Zlatan", Content = @"<h2>Is she dead, yes or no?</h2>
<p>Now that we know who you are, I know who I am. I'm not a mistake! It all makes sense! In a comic, you know how you can tell who the arch-villain's going to be? He's the exact opposite of the hero. And most times they're friends, like you and me! I should've known way back when... You know why, David? Because of the kids. They called me Mr Glass. </p>
...
", Online= true }, 
            ...
            tags2.ForEach(s => context.Tags.Add(s));
            /*
            tags2.ForEach(s => s.Posts.Add(context.Posts.Single(i => i.PostId == 1)));
            tags2.ForEach(s => s.Posts.Add(context.Posts.Single(i => i.PostId == 2)));
            tags2.ForEach(s => s.Posts.Add(context.Posts.Single(i => i.PostId == 3)));
            tags2.ForEach(s => s.Posts.Add(context.Posts.Single(i => i.PostId == 4)));
            tags2.ForEach(s => s.Posts.Add(context.Posts.Single(i => i.PostId == 5)));
            tags2.ForEach(s => s.Posts.Add(context.Posts.Single(i => i.PostId == 6)));
            */
            context.SaveChanges();
/*
            var listTags = context.Tags.ToList();
